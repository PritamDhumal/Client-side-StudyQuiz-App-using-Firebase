...
public class AddQuestionActivity extends AppCompatActivity {
    ...
    private void upload(){
        ...
        for (int i = 0;i < options.getChildCount();i++){
            ...
            EditText answwer = (EditText) answers .getChildAt(i);
            if (answwer.getText().toString().isEmpty()){
                answwer.setError("Required");
                return;
            }
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    ...
                    ,map.get("optionA").toString(),map.get("optionB").toString(),map.get("optionC").toString()
                            ,map.get("optionD").toString(),map.get("correctANS").toString()
                    ...
                    Toast.makeText(AddQuestionActivity.this, "Something wean wrong", Toast.LENGTH_SHORT).show();
                }
